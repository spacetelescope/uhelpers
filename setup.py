...
PACKAGENAME = metadata.get('package_name', 'uhelpers')
DESCRIPTION = metadata.get('description', 'Collection of helper modules.')
...
if sys.version_info < tuple((int(val) for val in __minimum_python_version__.split('.'))):
    sys.stderr.write("ERROR: uhelpers requires Python {} or later\n".format(__minimum_python_version__))
    sys.exit(1)
